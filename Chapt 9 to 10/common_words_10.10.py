...
raj = Path('romeo_and_juliet.txt').read_text(encoding='utf-8')
#print(raj)

#raj = 'The the the The the.'
#count word 'the'
word_to_count = 'the'
print(f"Number of words '{word_to_count}': {raj.count(word_to_count)}")
print(f"Number of words '{word_to_count}' in non case-sensitive manner: "
      f"{raj.lower().count(word_to_count)}")
print(f"Number of words '{word_to_count} ': in non case-sensitive manner "
      f"and with space in the end: {raj.lower().count(word_to_count + ' ')}")
